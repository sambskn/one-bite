...
pub fn generate_world(
    ...
    let psuedo_rng_val_1 =
        time.elapsed_secs_f64() * 100.0 - (time.elapsed_secs_f64() * 100.0).floor();
    let psuedo_rng_val_2 =
        time.elapsed_secs_f64() * 1234.0 - (time.elapsed_secs_f64() * 1234.0).floor();
    let target = Target {
        position: Vec2::new(
